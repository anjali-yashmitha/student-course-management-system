...
if (
  ...
  <form style="max-width: 600px;" action="Action/upload-profile-details.php" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" value="<?= $instructor['email'] ?>" name="email">
    </div>
    <div class="mb-3">
      <label class="form-label">Date of birth</label>
      <input type="date" class="form-control" value="<?= $instructor['date_of_birth'] ?>" name="date_of_birth">
    </div>
  ...
  <form id="ChangePassword" method="post" action="Action/change-password.php" style="max-width: 600px;">
    ...
    <div class="mb-3">
      ...
      <div class="input-group">
        <input type="password" class="form-control" id="instructorPassword" name="new_password"
          placeholder="Enter new password" aria-describedby="generatePasswordButton">
    ...
    <div class="mb-3">
      ...
      <input type="password" placeholder="Current password" class="form-control" id="confirmPassword"
