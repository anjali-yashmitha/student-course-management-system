...
if (
  ...
  $title = "DreamAcademy - Upload Courses Materials ";
  ...
  <div class="container">
    ...
    <div class="list-table pt-5">
      ...
      <form id="Chapter" class="mt-5 border p-4" action="Action/upload-materials.php" enctype="multipart/form-data"
        method="POST" style="max-width: 700px;">
        <?php
        if (isset($_GET['error'])) { ?>
