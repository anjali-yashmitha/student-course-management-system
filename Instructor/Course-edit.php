    ...
    <div class="card-body">
      <form>
        <div class="mb-3">
          ...
          <input type="text" class="form-control" value="Machine Learning Algorithms in Python">
        </div>
        <div class="mb-3">
      ...
      <form class="mt-5">
        ...
        <div class="mb-3">
          <input type="text" class="form-control" value="Chapter-1">
        </div>
        <div class="mb-3">
          <input type="text" class="form-control" value="Chapter-2">
        </div>
        <button type="submit" class="btn btn-primary">Save</button>
      </form>
            ...
            <ul class="list-group mb-3">
              <li class="list-group-item">
                <div class="mb-3 d-flex align-items-center">
                  ...
                  <input type="text" class="form-control" value="Topic-1">
                </div>
                <div class="mb-3 d-flex align-items-center">
                  <a href="Courses-content-edit.php"> <i class="fa fa-edit fs-4"></i></a>
                  <input type="text" class="form-control" value="Topic-2">
                </div>
              </li>
            </ul>
          </li>
