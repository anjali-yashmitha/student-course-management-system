...
if (
  ...
  # Header
  $title = "DreamAcademy - Courses Materials ";
  ...
  <div class="container">
    ...
    <div class="list-table pt-5">
      ...
      <h4>All Courses Materials (<?= $row_count ?>) <a href="Courses-Materials-add.php" class="btn btn-primary">Upload
          Material</a></h4><br>
      <?php if ($CoursesMaterials) { ?>
        <table class="table table-bordered">
          ...
          <?php foreach ($CoursesMaterials as $CoursesMaterial) { ?>
            <tr>
              <td><a href="<?= $CoursesMaterial["URL"] ?>"><img src="../assets/img/Logo.png" width="100"></td>
