...
if (
    ...
    $title = "DreamAcademy - Add Instructor ";
    ...
    <div class="container" style="padding: 0px;">
        <div class="d-flex">
            ...
            <!-- Main Content -->
            <div class="main-content flex-grow-1 p-4 d-flex justify-content-center align-items-center">
                <div class="w-100" style="max-width: 600px;">
                    <form class="shadow p-3" action="Action/instructor-add.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="instructorFirstName"
                                placeholder="Enter instructor's first name" name="fname" value="<?= $fname ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="instructorLastName" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="instructorLastName"
                                placeholder="Enter instructor's last name" name="lname" value="<?= $lname ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="instructorDOB" class="form-label">Date of Birth</label>
                            <input type="date" class="form-control" id="instructorDOB" value="<?= $bd ?>"
                                name="date_of_birth" required>
                        </div>
                        <div class="mb-3">
                            <label for="instructorEmail" class="form-label">Email</label>
                            <input type="email" class="form-control" id="instructorEmail"
                                placeholder="Enter instructor's email" name="email" value="<?= $email ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="instructorUsername" class="form-label">Username</label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="instructorUsername"
                                    placeholder="Enter instructor's username" name="username" value="<?= $uname ?>"
                                    required>
                                <button class="btn btn-outline-secondary" type="button" id="generateUsernameButton"
                                    onclick="generateUsername()">Auto Generate</button>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control" id="instructorPassword" name="password"
                                    placeholder="Enter new password" aria-describedby="generatePasswordButton" required>
                                <button class="btn btn-outline-secondary" type="button" id="generatePasswordButton"
