...
if (
  ...
  # Header
  $title = "DreamAcademy - " . $course['course']['title'];
                      ...
                      if ($topic['topic_id'] == $_topic_id) {
                        ...
                        <li>
                          <a href="Courses-Enrolled.php?course_id=<?= $course_id ?>&chapter_id=<?= $topic['chapter_id'] ?>&topic_id=<?= $topic['topic_id'] ?>"
                            class="btn badge-primary" style="color: #0D6EFD;">
                            <b><?= $topic['title'] ?></b></a>
                        </li>
                      <?php } else { ?>
                        <li>
                          <a href="Courses-Enrolled.php?course_id=<?= $course_id ?>&chapter_id=<?= $topic['chapter_id'] ?>&topic_id=<?= $topic['topic_id'] ?>"
                            class="btn badge-primary"><?= $topic['title'] ?></a>
                        </li>
                      <?php }
                    }
                  } ?>
          ...
          <div><br>
            ...
            <div class="progress mb-2">
              <div class="progress-bar" role="progressbar" style="width: <?= $progress ?>%;"
                aria-valuenow="<?= $progress ?>" aria-valuemin="0" aria-valuemax="100"><?= ceil($progress) ?>%</div>
            </div>
            <?php if ($progress == 100) { ?>
              <div class="text-center">
                <a class="btn btn-success"
                  href="Action/generateCertificate.php?course_id=<?= $course['content']['course_id'] ?>">Get Certificate</a>
              </div>
            <?php } else { ?>
              <div class="text-center">
